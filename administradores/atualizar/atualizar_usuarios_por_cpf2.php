...
?>
               <script language="JavaScript">
                    ...
                    document.location.href="atualizar_usuarios_por_cpf.php";
               </script>
<?php
          }
          else if(empty($cpf2))
...
<?php
          ...
          else
          {
               ...
               //Realizando consultas necessarioas
                    ...
                    $consultar_usuarios = mysqli_query($link, "SELECT * FROM $table_usuarios WHERE cpf = '$cpf'");
...
?>
               ...
               <center><a href="atualizar_usuarios_por_cpf.php"><input type="button" name="botao" value="VOLTAR"></a></center>
<?php
		}
     }
}
