...
<?php
		 ...
		 $consulta_ferramenta = "SELECT * FROM $table_ferramentas WHERE codigo_departamento = '$departamento' ORDER BY codigo_departamento, numeral ASC";
...
?>
               ...
               <center><a href="atualizar_imagem_ferramentas_por_departamento.php"><input type="button" name="botao" value="VOLTAR"></a></center>
<?php
		 }
     }
	} 
