...
?>
               <script language="JavaScript">
                    ...
                    document.location.href="atualizar_usuarios_por_nome.php";
               </script>
<?php
          }
          else
          {
			   ...
			   $consultar_nome = "SELECT * FROM $table_usuarios WHERE nome like '%".$nome."%' AND codigo_departamento = '$codigo_dep' ORDER BY nome ";
...
?>
               <tr>
					...
					<td align="center"><font color="black"><a href="atualizar_usuarios_confirmacao.php?codigo_login=<?php print($vetor_logins['codigo']);?>&codigo_usuario=<?php print($vetor_usuarios['codigo']);?>">Clique Aqui</a></td>
               </tr>
<?php
                    }
?>
               </table><br>
               <center><a href="atualizar_usuarios_por_nome.php"><input type="button" name="botao" value="VOLTAR"></a></center>
               </body>
               </html>
<?php
               }
