...
?>
          ...
          <body>
			   <center><h1> Visualizar usuário</h1></center>
...
<?php
                    ...
                    require("../../connect.php");
						 ...
						 $consultar_usuarios = mysqli_query($link, "SELECT * FROM $table_usuarios WHERE codigo_login = '$cod_log'");
...
?>
               <tr>
					...
					<td align="center"><font color="black"><a href="atualizar_usuarios_confirmacao.php?codigo_login=<?php print($vetor_logins['codigo']);?>&codigo_usuario=<?php print($vetor_usuarios['codigo']);?>">Clique Aqui</a>
               </tr>
               </table><br>
               <center><a href="atualizar.php"><input type="button" name="botao" value="VOLTAR"></a></center>
<?php
     }
?>
