...
<?php
					...
					$consultar_ferramentas = mysqli_query($link, "SELECT * FROM $table_ferramentas WHERE codigo_departamento = '$cod_dep' ORDER BY codigo_departamento, numeral ASC");
...
?>
               ...
               <center><a href="atualizar_imagem_ferramentas.php"><input type="button" name="botao" value="VOLTAR"></a></center>
<?php
     }
?>
