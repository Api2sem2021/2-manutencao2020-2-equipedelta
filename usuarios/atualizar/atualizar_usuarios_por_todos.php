...
<?php
                    ...
                    $consultar_usuarios = mysqli_query($link, "SELECT * FROM $table_usuarios WHERE codigo_departamento = '$cod_dep' ORDER BY nome");
...
?>
               ...
               <center><a href="atualizar_usuarios.php"><input type="button" name="botao" value="VOLTAR"></a></center>
<?php
     }
?>
