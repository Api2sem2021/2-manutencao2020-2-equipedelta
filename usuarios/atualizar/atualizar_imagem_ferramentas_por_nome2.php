...
<?php
		 ...
		 $consulta_nome = "SELECT * FROM $table_ferramentas WHERE nome like '%".$nome_ferramenta."%' AND codigo_departamento = '$codigo_dep' ORDER BY codigo_departamento, numeral ASC ";
...
?>
               <tr>
					...
					<td align="center"><font color="black"><a href="atualizar_imagem_ferramentas_confirmacao.php?codigo_ferramenta=<?php print($vetor_ferramentas['codigo']);?>&codigo_departamento=<?php print($vetor_departamento['codigo']);?>">Clique Aqui</a></td>
               </tr>
<?php
						}
?>
...
?>
               ...
               <center><a href="atualizar_imagem_ferramentas_por_nome.php"><input type="button" name="botao" value="VOLTAR"></a></center>
<?php
		 }
     }
	} 
