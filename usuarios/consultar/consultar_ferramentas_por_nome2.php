...
<?php
		 ...
		 $consulta_dep = mysqli_query($link, "SELECT * FROM $table_usuarios WHERE codigo_login = '$codigo_login'");
		 $vetor_dep = mysqli_fetch_array($consulta_dep);
		 $codigo_dep = $vetor_dep['codigo_departamento'];
...
?>
               ...
               <center><a href="consultar_ferramentas_por_nome.php"><input type="button" name="botao" value="VOLTAR"></a></center>
<?php
		 }
     }
	} 
