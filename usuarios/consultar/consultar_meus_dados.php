...
?>
          ...
          <title>Visualizar Meus Dados</title>
          <link rel="stylesheet" href="../css/bootstrap.css">
          <link rel="stylesheet" href="../fonts/ionicons.min.css">
          <link rel="stylesheet" href="../css/styles.min.css">
               </head>
          <body>
			   <center><h1> Visualizar Meus Dados</h1></center>
...
<?php
                    ...
                    $consultar_usuarios = mysqli_query($link, "SELECT * FROM $table_usuarios WHERE codigo_login = '$codigo_login'");
