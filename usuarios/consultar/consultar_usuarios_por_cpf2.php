...
?>
               <script language="JavaScript">
                    ...
                    document.location.href="consultar_usuarios_por_cpf.php";
               </script>
<?php
          }
          else if(empty($cpf2))
...
<?php
          ...
          else
          {
               ...
               //Realizando consultas necessarioas
					...
					$consulta_usuario_dep = mysqli_query($link, "SELECT * FROM $table_usuarios WHERE codigo_login = '$codigo_login'");
					$resultado_usuario_dep = mysqli_fetch_array($consulta_usuario_dep);
					$codigo_dep = $resultado_usuario_dep['codigo_departamento'];
...
?>
               ...
               <center><a href="consultar_usuarios_por_cpf.php"><input type="button" name="botao" value="VOLTAR"></a></center>
<?php
		}
     }
}
