...
?>
          ...
          <form name="f" method="get" action="excluir_ferramentas_por_departamento2.php">
          <tr>
...
?>
			   ...
			   <br><br>
			   <input type="submit" name="botao" value="ENVIAR"> <input type="reset" name="botao" value="LIMPAR"> <a href="excluir_ferramentas.php"><input type="button" name="botao" value="VOLTAR"></a><br><br>
