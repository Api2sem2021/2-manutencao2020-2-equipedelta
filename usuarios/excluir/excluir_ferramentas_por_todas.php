...
<?php
					...
					$consultar_ferramentas = mysqli_query($link, "SELECT * FROM $table_ferramentas WHERE codigo_departamento = '$codigo_dep' ORDER BY codigo_departamento, part_number, nome ASC");
...
?>
               ...
               <center><a href="excluir_ferramentas.php"><input type="button" name="botao" value="VOLTAR"></a></center>
<?php
     }
?>
